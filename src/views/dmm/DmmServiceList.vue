<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <dmmService-modal ref="modalForm" @ok="modalFormOk"></dmmService-modal>
  </a-card>
</template>

<script>
  import DmmServiceModal from './modules/DmmServiceModal'
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/dmmService/dmmService/list",
          delete: "/dmmService/dmmService/delete",
          deleteBatch: "/dmmService/dmmService/deleteBatch",
          exportXlsUrl: "dmmService/dmmService/exportXls",
          importExcelUrl: "dmmService/dmmService/importExcel",
       },
    }
  },
  computed: {
