    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="创建时间">
          <a-date-picker showTime format='YYYY-MM-DD HH:mm:ss' v-decorator="[ 'createTime', validatorRules.createTime ]" />
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/dmmCatsCategory/dmmCatsCategory/add",
          edit: "/dmmCatsCategory/dmmCatsCategory/edit",
        },
      }
    },
    created () {
